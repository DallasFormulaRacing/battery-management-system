...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7|WriteProtect_EEPROM_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PC7 WriteProtect_EEPROM_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_7|WriteProtect_EEPROM_Pin;
